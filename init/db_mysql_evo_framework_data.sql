...
insert into config_property values (null, 'master', 'evo', 'default', 'evo.controller.docker-swarm.host', '192.168.18.138', 'Docker Swarm Http REST API host [Default localhost]', '1', now(), '1', now());
...
insert into config_property values (null, 'master', 'evo', 'default', 'evo.controller.eureka.service-id', 'evo-eureka', '注册中心的 Spring Application Name [Default evo-eureka]', '1', now(), '1', now());
...
insert into config_property values (null, 'master', 'evo', 'sit', 'evo.controller.docker-swarm.host', '10.20.196.19', 'Docker Swarm Http REST API host [Default localhost]', '1', now(), '1', now());
...
insert into zuul_route values (null, 'evo-communication', '/communication/**', 'evo-communication', null, '1', null, null, '1', null, '1', now(), '1', now());
insert into zuul_route values (null, 'evo-controller', '/controller/**', 'evo-controller', null, '1', null, null, '1', null, '1', now(), '1', now());
insert into zuul_route values (null, 'evo-datadict', '/datadict/**', 'evo-datadict', null, '1', null, null, '1', null, '1', now(), '1', now());
