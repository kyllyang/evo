...
public class SR {
	...
	static {
		...
		MESSAGE_MAP.put(RC.CONTROLLER_DOCKER_SWARM_SERVICES, "删除Docker Swarm Service失败，[%s]");
	...
	public static enum RC {
		...
		CONTROLLER_DOCKER_SWARM_SERVICES("CONTROLLER-0201"),
		CONTROLLER_DOCKER_SWARM_TASKS("CONTROLLER-0301"),

		CONTROLLER_SPRING_CLOUD_CONFIG_PROPERTY_EXIST("CONTROLLER-0301"),
		CONTROLLER_SPRING_CLOUD_CONFIG_PROPERTY_DUPLICATE("CONTROLLER-0302");
