...
public class SR {
	...
	static {
		...
		MESSAGE_MAP.put(RC.CONTROLLER_DOCKER_SWARM_NODES, "删除Docker Swarm Node失败，[%s]");
	...
	public static enum RC {
		...
		CONTROLLER_DOCKER_SWARM_NODES("CONTROLLER-0001"),
		CONTROLLER_DOCKER_SWARM_SERVICES("CONTROLLER-0101"),
		CONTROLLER_DOCKER_SWARM_TASKS("CONTROLLER-0201"),

		CONTROLLER_SPRING_CLOUD_CONFIG_PROPERTY_EXIST("CONTROLLER-0301");
